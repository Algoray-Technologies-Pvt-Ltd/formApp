...
class ApprovedDateWidgetEn extends StatelessWidget {
  ApprovedDateWidgetEn({super.key});
          ...
          return TextFormField(
            controller: dateController
              ..text = context.select((EnquiryReviewBloc bloc) =>
                  bloc.state.enquiryReview?.AmandmentApprovedDate != null
                      ? DateFormat('yyyy-MM-dd').format(
                          bloc.state.enquiryReview!.AmandmentApprovedDate!)
                      : ''),
            ...
            onTap: () async {
              ...
              if (pickedDate != null) {
                ...
                context
                    ...
                    .add(AmandmentApprovedDateEvent(date: selectedDate));
