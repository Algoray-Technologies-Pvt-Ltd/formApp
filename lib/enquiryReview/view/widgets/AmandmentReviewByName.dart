...
class AmandmentReviewByName extends StatefulWidget {
  @override
  State<AmandmentReviewByName> createState() => _AmandmentReviewByNameState();
}

TextEditingController textcontroller = TextEditingController();

class _AmandmentReviewByNameState extends State<AmandmentReviewByName> {
  @override
        ...
        child: Container(
            ...
            child: TypeAheadFormField(
              ...
              onSuggestionSelected: (suggestion) {
                ...
                context.read<EnquiryReviewBloc>().add(AmandmentReviewByEvent(
                    AmandmentReviewBy: suggestion.toString()));
              },
              validator: (value) =>
