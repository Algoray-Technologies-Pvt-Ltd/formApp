...
class ApprovelByName extends StatefulWidget {
  @override
  State<ApprovelByName> createState() => _ApprovelByNameState();
}

TextEditingController textcontroller = TextEditingController();

class _ApprovelByNameState extends State<ApprovelByName> {
  @override
            ...
            child: TypeAheadFormField(
              ...
              onSuggestionSelected: (suggestion) {
                ...
                context
                    ...
                    .add(ApprovelByEvent(approval: suggestion.toString()));
              },
              validator: (value) =>
