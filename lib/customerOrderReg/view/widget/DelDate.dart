...
class DelDateCORWidget extends StatelessWidget {
  DelDateCORWidget({super.key});
          ...
          return TextFormField(
            controller: dateController
              ..text = context.select((CustomerOrderRegBloc bloc) =>
                  bloc.state.customerOrderReg?.DelDate != null
                      ? DateFormat('yyyy-MM-dd')
                          .format(bloc.state.customerOrderReg!.DelDate!)
                      : ''),
            ...
            onTap: () async {
              ...
              if (pickedDate != null) {
                ...
                context
                    ...
                    .add(DelDateEvent(date: selectedDate));
